" in Linux Mint ln -s ~/Documents/GitHub/cheat-sheet_vim/vimrc   ~/.vim/vimrc
" in Linux Mint ln -s ~/Documents/GitHub/cheat-sheet_vim/vimrc " ~/usr/local/share/nvim/sysinit.vim
" in Linux Mint ln -s ~/Documents/GitHub/cheat-sheet_VIM/vimrc " ~/.config/nvim/init.vim
" in Windows _vimrc
